...
1. Task #5 could not be performed because selecting rows and columns to copy is not available for AG Grid Community Edition.
2. In replacement of AG Grid coping function, I activated the text selection property, which is the closest function to the AG Grid coping function.